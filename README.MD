...
_Note : Un jeu de données prêt à l'emploi est disponible dans `/Liverables/db/export_nextask.sql` si vous souhaitez réinitialiser la base de données avec des exemples concrets._
